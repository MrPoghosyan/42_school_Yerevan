...
- Addition
- Comparison
- **Digitshift** (similar to bitshift, but instead of shifting bits you shift decimal digits)
...
Your `bigint` must be printable with the `<<` operator (base 10), and the output should **not contain any leading zeros**.
